...
def main():
    ...
    astros['W/L'] = astros['W/L'].str.replace('*', '', regex=False)
...
def main():
    ...
    # Make sure to account for errors if no data is available for certain opponents or year
...
# Account for errors that could arise if there are no W's or L's
...
def main():
    ...
    # Dictionary for the divisions and teams
    divisions_to_teams = {
